  ...
  return (Conditional createBool whenTrue whenFalse)
    where
      ...
      brackettedExpr_ = do
        ...
        return p
      false_ = do
        void $ P.string (T.pack "false")
        return (ConstBool False)
      true_ = do
        void $ P.string (T.pack "true")
...
ws_ = do
  P.skipSpace
  void $ sepBy (choice [commentBlock_, commentLine_]) P.skipSpace
  P.skipSpace
  return ()
    where
      commentBlock_ =
